...
const MOCK_EVENTS = [
    ...
    },
    {
        ...
        startAt: new Date(new Date().setHours(7, 0, 0, 0)).toISOString(),
        venueName: "城山ホテル鹿児島",
        area: "城山",
        lat: 31.597,
        lng: 130.551,
    ...
    },
    {
        ...
        startAt: new Date(new Date().setDate(new Date().getDate() + 6)).toISOString(),
    ...
    },
    {
        ...
        startAt: new Date(new Date().setHours(21, 0, 0, 0)).toISOString(),
...
async function seed() {
    ...
    for (const event of MOCK_EVENTS) {
        // Use ID from mock as doc ID for consistency
